...
### 📍 Data Analyst & Data Operations Lead — Mersal Foundation
**Feb 2025 – Present**

- Built a centralized database from **100+ fragmented files**
- Automated reporting workflows using **Excel, Python, and Power BI**
- Reduced monthly reporting cycle by **75%**
- Improved data accuracy by redesigning case tracking systems
- Delivered executive-level analytical reports for multiple departments

---

## 📌 Featured Projects

### 📈 Sales Analysis & Return Management Dashboard
**Python • Excel • Power BI**

- Built a 6-page interactive dashboard analyzing sales and return trends
- Identified profitable categories and loss-driving products
- Delivered recommendations that improved inventory efficiency and reduced returns

---

### 🎯 Customer Behavior & Promotional Strategy Analysis
**Python • Power BI**

- Analyzed customer demographics and campaign performance
- Identified top-performing customer segments and offers
- Developed KPI dashboards for business performance monitoring
